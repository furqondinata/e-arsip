...
class Arsip extends BaseController
{
    ...
    public function insert()
    {
        if ($this->validate([
            ...
            'file_arsip' => [
                'label'  => 'File Arsip',
                'rules'  => 'uploaded[file_arsip]|max_size[file_arsip,3048]|ext_in[file_arsip,pdf]',
                'errors' => [
                    'uploaded'   => '{field} Wajib Diisi !!!',
                    'max_size'   => 'Ukuran{field} Max 3048 kb  !!!',
    ...
    public function update($id_arsip)
    {
        if ($this->validate([
            ...
            'file_arsip' => [
                'label'  => 'File Arsip',
                'rules'  => 'max_size[file_arsip,3048]|ext_in[file_arsip,pdf]',
                'errors' => [
